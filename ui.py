"""Personal Private Encryptor.

A simple application to encrypt and decrypt files and folders using fernet.

This module provides a graphical user interface for encryption and decryption
operations using the tkinter and fernet libraries.

Author: Harry R.
GitHub: https://github.com/HarryR275/PersonalPrivateEncryptor/tree/main
Email: harryrdev@gmail.com
"""
...
def openencryptwindow(key: bytes) -> None:
    """Open the encryption UI window."""
    ...
    enbutton1 = tk.Button(
        encryptwindow,
        text="Single File",
        command=lambda: enbutton1_click(key),
    )
    enbutton2 = tk.Button(
        encryptwindow,
        text="Entire Folder",
        command=lambda: enbutton2_click(key),
    )

    # A Label widget to show in toplevel
    tk.Label(encryptwindow, text="Encrypt Window").pack()

    enbutton1.pack(pady=5)
    enbutton2.pack()


def enbutton1_click(key: bytes) -> None:
...
def enbutton2_click(key: bytes) -> None:
...
def openDecryptWindow(key):
    ...
    tk.Label(DecryptWindow, text="Decrypt Window").pack()
    # Create the buttons
    enbutton1 = tk.Button(
        DecryptWindow,
        text="Single File",
        command=lambda: debutton1_click(key),
    )
    enbutton2 = tk.Button(
        DecryptWindow,
        text="Entire Folder",
        command=lambda: debutton2_click(key),
    )
